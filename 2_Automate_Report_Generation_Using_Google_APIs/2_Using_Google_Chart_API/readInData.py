...
#From here on is new!
#In the head, we will paste the script that was copied from "https://developers.google.com/chart/interactive/docs/basic_load_libs" / don't forget to remove the "..." at the end. 
...
with open('column_chart_html','w') as f:
